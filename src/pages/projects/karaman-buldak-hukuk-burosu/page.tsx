...
const KaramanBuldakHukukBurosuPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/d8e80bc20b39624f7b2a02d6b3edb98d.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/5c9b73d099567d3badebf8a319267732.jpeg'
  ];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary-50 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center text-sm text-primary-600">
              ...
              <i className="ri-arrow-right-s-line mx-2"></i>
              <span className="text-primary-900 font-semibold">Karaman Bulduk Hukuk Bürosu</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-primary-900 mb-6">Karaman Bulduk Hukuk Bürosu</h1>
            <div className="flex flex-wrap items-center gap-6 text-primary-600 mb-8">
              <div className="flex items-center">
                <i className="ri-map-pin-line text-xl mr-2"></i>
                <span className="text-lg">Beşiktaş / İstanbul</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-lg">Büro Yenileme</span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  Karaman Bulduk Hukuk Bürosu projesi, profesyonel bir çalışma ortamının yeniden tasarlanması ve modernizasyonu üzerine odaklanmıştır. Projenin temel amacı, hukuk bürosunun prestijini yansıtan, fonksiyonel ve estetik açıdan mükemmel bir mekan yaratmaktır.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  Tasarım sürecinde, çalışanların verimliliğini artıracak ergonomik çözümler ile müvekkillere güven veren profesyonel bir atmosfer oluşturulması hedeflenmiştir. Modern mimari anlayış, kaliteli malzeme seçimleri ve detaylı işçilik bir araya getirilerek, zarafet ve işlevselliğin mükemmel dengesi sağlanmıştır.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed">
                  BOOP Mimarlık olarak, mimari tasarım, peyzaj düzenlemesi ve proje yönetimi süreçlerinin tamamını koordine ederek, müşteri beklentilerini aşan bir sonuç ortaya koyduk. Her detay özenle planlanmış ve uygulanmıştır.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    ...
                    <span className="text-primary-900">Büro Yenileme</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    <span className="font-semibold text-primary-700">Konum:</span>
                    <span className="text-primary-900">Beşiktaş / İstanbul</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                  ...
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    ...
                    <span className="text-primary-900">Mimari, Peyzaj, Proje Yönetimi</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Karaman Bulduk Hukuk Bürosu - Görsel ${index + 1}`}
          ...
          >
            ...
            <div className="max-w-6xl max-h-[90vh] px-16" onClick={(e) => e.stopPropagation()}>
              <img
                ...
                alt={`Karaman Bulduk Hukuk Bürosu - Görsel ${currentImageIndex + 1}`}
...
export default KaramanBuldakHukukBurosuPage;
