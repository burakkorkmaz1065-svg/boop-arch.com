...
const MoxyMarriottOteliPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/9c29b545c607e48bb04173f257901354.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/9d5ccd8421c38c16d9408948828902a6.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/20cb291751b9469a141626e767bc2806.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/6a8373c317ec9accf070d6c1ed4faeeb.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/15944120950cef944f797c23f2d0f4c5.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/35bcbb5e2eafe8caa1662a7c21882c30.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/0a65872f06715d72085034212bb78340.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/e492f1082fdefed7fe30dd278a27459b.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/9295b85a3a003ffe08bc571091465c0f.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/e567c79d83316e7b84dcb55ace9ddf5f.jpeg'
  ];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary-50 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center text-sm text-primary-600">
              ...
              <i className="ri-arrow-right-s-line mx-2"></i>
              <span className="text-primary-900 font-semibold">Moxy Marriott Oteli</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-primary-900 mb-6">Moxy Marriott Oteli</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  Moxy Marriott Oteli, Marriott'un genç ve dinamik otel konsepti Moxy'nin İstanbul'daki temsilcisidir. Modern, enerjik ve yaratıcı tasarım anlayışıyla şekillenen bu proje, yeni nesil seyahat deneyimini yansıtmaktadır.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  BOOP Mimarlık olarak, Moxy'nin global tasarım standartlarını yerel kültürel öğelerle harmanlayarak özgün bir mekan yarattık. Otelin lobisi, odaları, bar alanı ve ortak mekanları canlı renkler, endüstriyel detaylar ve modern mobilyalarla tasarlandı.Proje tasarımını Designist ekibi yapmıştır.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed">
                  Proje kapsamında mimari tasarım, iç mekan düzenlemesi ve uygulama süreçlerini yönettik. Kompakt ama fonksiyonel oda tasarımları, sosyal etkileşimi teşvik eden ortak alanlar ve yaratıcı detaylarla Moxy'nin eğlenceli ve samimi atmosferini yakaladık.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Moxy Marriott Oteli - Görsel ${index + 1}`}
...
export default MoxyMarriottOteliPage;
