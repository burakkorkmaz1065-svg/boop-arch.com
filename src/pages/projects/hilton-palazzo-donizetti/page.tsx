...
const HiltonPalazzoDonizettiPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/162a6c5976a3645a7943de26d9a110f1.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/5ff9af363463dc5bb98a9caad3e8d84f.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/4f93e845b65c407126c35262c6bcf0cb.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/bac79adcc4d73d7ff959290b683229fb.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/cbed995e5e8b5252f26f7596f04b8251.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/0b77672c46bee8ca7975811a14a1cc60.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/bee275a00a1343e8efea2cef5994ff9d.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/10e408d29eb27bf4da404ff629cb4891.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/4511c7459251af0f872bab7ff5787027.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/79b54eee8611bef3eca2525b7230d631.jpeg'
  ];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary-50 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center text-sm text-primary-600">
              ...
              <i className="ri-arrow-right-s-line mx-2"></i>
              <span className="text-primary-900 font-semibold">Hilton Palazzo Donizetti</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-primary-900 mb-6">Hilton Palazzo Donizetti</h1>
            <div className="flex flex-wrap items-center gap-6 text-primary-600 mb-8">
              ...
              <div className="flex items-center">
                ...
                <span className="text-lg">Butik Otel</span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  Hilton Palazzo Donizetti, İstanbul'un tarihi yarımadasında yer alan prestijli bir otel restorasyon ve yenileme projesidir. Tarihi binanın özgün mimarisini koruyarak modern konfor standartlarına kavuşturulması hedeflenmiştir.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  BOOP Mimarlık olarak, bu prestijli projede mimari restorasyon, iç mekan yenileme ve detay tasarım hizmetleri sunduk. Tarihi dokuya saygılı yaklaşımımızla, otelin özgün karakterini korurken çağdaş lüks standartlarını yakaladık.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed">
                  Proje kapsamında otelin Mock-up odaları, koridorları hazırlandı. Hilton standartları kontrolü yapılarak benzersiz mekanlar yaratıldı. Hilton'un global standartlarını yerel mimari değerlerle harmanlayarak benzersiz bir mekan yarattık.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    ...
                    <span className="text-primary-900">Butik Otel</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Hilton Palazzo Donizetti - Görsel ${index + 1}`}
...
export default HiltonPalazzoDonizettiPage;
