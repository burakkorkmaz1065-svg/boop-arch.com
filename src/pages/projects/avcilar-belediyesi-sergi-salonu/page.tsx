...
const AvcilarBelediyesiSergiSalonuPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/56806a1c0b0c252fd88a84a0af1d6925.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/c877047f904f1fbec281aee44b5bf30e.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/6b468f3c8b0e30e4e0e87e0a3ef752df.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/8db8430218330bf89ea41b4fcf843da3.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/1c87390eaca8a9c16d56c2c36582035b.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/f70e54bb0a0575db87d7ca4cf1111969.jpeg',
    'https://static.readdy.ai/image/e78687b2456904d2334721dafeba36ce/e1ca279a403e625112c33a321bf96794.jpeg',
  ];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary-50 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center text-sm text-primary-600">
              ...
              <i className="ri-arrow-right-s-line mx-2"></i>
              <span className="text-primary-900 font-semibold">Avcılar belediyesi Ispartakule Kapalı Fuar ve Sergi Salonu</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-primary-900 mb-6">Avcılar belediyesi Ispartakule Kapalı Fuar ve Sergi Salonu</h1>
            <div className="flex flex-wrap items-center gap-6 text-primary-600 mb-8">
              <div className="flex items-center">
                <i className="ri-map-pin-line text-xl mr-2"></i>
                <span className="text-lg">İstanbul, Avcılar</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-lg">Kültürel Mekan</span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  Avcılar belediyesi Ispartakule Kapalı Fuar ve Sergi Salonu, İstanbul Avcılar ilçesinde halkın sanat ve kültür etkinliklerine ev sahipliği yapacak modern bir kültürel mekan projesidir. Çağdaş mimari anlayışla tasarlanan salon, esnek kullanım alanları ve profesyonel sergileme imkanları sunmaktadır.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed mb-6">
                  BOOP Mimarlık olarak, bu kamusal projede mimari tasarım ve iç mekan düzenlemesi hizmetleri sunduk. Geniş sergi alanları, profesyonel aydınlatma sistemleri ve esnek mekan organizasyonu ile farklı türdeki sergilere ve etkinliklere uyum sağlayabilen bir yapı tasarladık.
                </p>
                <p className="text-lg text-primary-700 leading-relaxed">
                  Salonun geniş cam cephesi doğal ışık alımını maksimize ederken, modern mimari dili ile çevreye değer katmaktadır. İç mekanda kullanılan beyaz yüzeyler ve minimalist tasarım, sergilenen eserlerin ön plana çıkmasını sağlamaktadır.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    ...
                    <span className="text-primary-900">Sergi Salonu</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    <span className="font-semibold text-primary-700">Konum:</span>
                    <span className="text-primary-900">İstanbul, Avcılar</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
                    <span className="font-semibold text-primary-700">Tamamlanma Yılı:</span>
                    <span className="text-primary-900">2020</span>
                  </div>
                  <div className="flex justify-between border-b border-primary-200 pb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Avcılar belediyesi Ispartakule Kapalı Fuar ve Sergi Salonu - Görsel ${index + 1}`}
...
export default AvcilarBelediyesiSergiSalonuPage;
